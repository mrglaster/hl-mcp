...
Jump to: [navigation](https://wiki.alliedmods.net/Debugging_Plugins_\(AMX_Mod_X\)#mw-head), [search](https://wiki.alliedmods.net/Debugging_Plugins_\(AMX_Mod_X\)#p-search)
[AMX Mod X](https://wiki.alliedmods.net/AMX_Mod_X "AMX Mod X") features a greatly enhanced plugin debugger over AMX Mod. If your plugin is giving runtime errors, you should enable the debugger by opening amxmodx/configs/plugins.ini and appending " debug" to your plugin's entry, like so: 
```
myplugin.amxx debug
