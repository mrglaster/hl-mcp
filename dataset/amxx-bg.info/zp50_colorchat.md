# Functions in zp50_colorchat.inc
Function | Description  
---|---  
[zp_colored_print](https://amxx-bg.info/api/zp50_colorchat/zp_colored_print) | ```
This function has no description.
```
  

This code is a part of zp50_colorchat.inc. To use this code you should include zp50_colorchat.inc as ```#include <zp50_colorchat>```
