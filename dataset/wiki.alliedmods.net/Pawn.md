...
(Redirected from [Pawn](https://wiki.alliedmods.net/index.php?title=Pawn&redirect=no "Pawn"))
Jump to: [navigation](https://wiki.alliedmods.net/Pawn#mw-head), [search](https://wiki.alliedmods.net/Pawn#p-search)
...
## Contents
  * [1 Introduction](https://wiki.alliedmods.net/Pawn#Introduction)
    * [1.1 Language Paradigms](https://wiki.alliedmods.net/Pawn#Language_Paradigms)
    * [1.2 Implementation Features](https://wiki.alliedmods.net/Pawn#Implementation_Features)
    * [1.3 License](https://wiki.alliedmods.net/Pawn#License)
  * [2 Variables](https://wiki.alliedmods.net/Pawn#Variables)
    * [2.1 Types](https://wiki.alliedmods.net/Pawn#Types)
      * [2.1.1 Integers](https://wiki.alliedmods.net/Pawn#Integers)
      * [2.1.2 Floats](https://wiki.alliedmods.net/Pawn#Floats)
      * [2.1.3 Booleans](https://wiki.alliedmods.net/Pawn#Booleans)
  * [3 Arrays](https://wiki.alliedmods.net/Pawn#Arrays)
  * [4 Strings](https://wiki.alliedmods.net/Pawn#Strings)
  * [5 Functions](https://wiki.alliedmods.net/Pawn#Functions)
  * [6 Expressions](https://wiki.alliedmods.net/Pawn#Expressions)
  * [7 Conditionals](https://wiki.alliedmods.net/Pawn#Conditionals)
    * [7.1 If Statements](https://wiki.alliedmods.net/Pawn#If_Statements)
    * [7.2 Switch Statements](https://wiki.alliedmods.net/Pawn#Switch_Statements)
  * [8 Looping](https://wiki.alliedmods.net/Pawn#Looping)
    * [8.1 For Loops](https://wiki.alliedmods.net/Pawn#For_Loops)
    * [8.2 While Loops](https://wiki.alliedmods.net/Pawn#While_Loops)
    * [8.3 Two Dimensional Arrays](https://wiki.alliedmods.net/Pawn#Two_Dimensional_Arrays)
  * [9 Compiler Pre-processor Directives](https://wiki.alliedmods.net/Pawn#Compiler_Pre-processor_Directives)
  * [10 Conclusion](https://wiki.alliedmods.net/Pawn#Conclusion)
  * [11 External Links](https://wiki.alliedmods.net/Pawn#External_Links)
...
There are many different operators you can use inside the if () statement. In fact, you can use any [expression](https://wiki.alliedmods.net/Pawn#Expressions) that evaluates to true (not zero) or false (zero). 
```
