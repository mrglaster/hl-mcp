# Обновление HUD 03.12.23 

В связи с выходом обновлений в Steam Half-Life 25 лет, испортился HUD оружия на серверах, использующих Half-Life Weapon Mod, тк добавили поддержку более высоких разрешений.
Структура файлов изменилась... На примере weapon_357.txt
...
Для генерации недостающих спрайтов можно воспользоваться утилитой [Half-Life Weapon Sprites HUD Upscaler](https://github.com/mrglaster/hl-hud-upscaler).
