...
#### Usage
startpos | ```Starting coordinates of the beam```
---|---
endpos | ```Ending coordinates of the beam```
...
noise | ```The noise amplitude of the beam, this controls the distorsion of the beam (0 - 255)```
