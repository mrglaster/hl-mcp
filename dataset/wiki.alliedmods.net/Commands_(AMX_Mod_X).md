...
Jump to: [navigation](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#mw-head), [search](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#p-search)
...
---  
**View this page in:** English [Russian](https://wiki.alliedmods.net/index.php?title=Ru:Commands_\(amx_mod_x\)&action=edit&redlink=1 "Ru:Commands \(amx mod x\) \(page does not exist\)") [简体中文(Simplified Chinese)](https://wiki.alliedmods.net/index.php?title=Zh_cn:Commands_\(amx_mod_x\)&action=edit&redlink=1 "Zh cn:Commands \(amx mod x\) \(page does not exist\)") |   
  

## Contents
  * [1 Introduction](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Introduction)
  * [2 Admin Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Admin_Commands)
  * [3 Chat Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Chat_Commands)
  * [4 Vote Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Vote_Commands)
  * [5 Stats Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Stats_Commands)
  * [6 Say Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Say_Commands)
  * [7 Menu Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Menu_Commands)
  * [8 Config Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#Config_Commands)
  * [9 RCON Commands](https://wiki.alliedmods.net/Commands_\(AMX_Mod_X\)#RCON_Commands)
...
# Stats Commands      Command  | Description   
---|---  
...
# Say Commands      Command  | Description   
---|---  
...
# Menu Commands
`**Note:** ACCESS_LEVEL_A is not "a", it is "m".  See Access Levels[](https://wiki.alliedmods.net/Adding_Admins_\(AMX_Mod_X\)#Access_Levels "Adding Admins \(AMX Mod X\)").`      Command  | Accesss  | Description   
---|---|---  
