. Advanced Topics
Areas of Interest:
  1. [Tasks/Timers](http://127.0.0.1:8000/content/advanced.htm#tasks)
  2. [Menus](http://127.0.0.1:8000/content/advanced.htm#menus)
  3. [Events/Messages](http://127.0.0.1:8000/content/advanced.htm#events)
  4. [Catching Logs](http://127.0.0.1:8000/content/advanced.htm#logs)
  5. [Multi-Lingual Support](http://127.0.0.1:8000/content/advanced.htm#ml)
  6. [SQL Support](http://127.0.0.1:8000/content/advanced.htm#sql)
  7. [Regular Expressions](http://127.0.0.1:8000/content/advanced.htm#regex)
  8. [Entities](http://127.0.0.1:8000/content/advanced.htm#ents)
  9. [FakeMeta](http://127.0.0.1:8000/content/advanced.htm#fm)
...
Regular Expressions let you describe ways in which to break down strings. They are extremely powerful. AMX Mod X uses the Perl Compatible RE library, you can read the specifics at [their site](http://www.pcre.org/). AMX Mod X offers regular expressions with the regex_amxx module. Here is a short example:  
