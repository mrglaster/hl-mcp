...
Jump to: [navigation](https://wiki.alliedmods.net/Frequently_Asked_Questions_\(AMX_Mod_X\)#mw-head), [search](https://wiki.alliedmods.net/Frequently_Asked_Questions_\(AMX_Mod_X\)#p-search)
These are some frequently asked questions about [AMX Mod X](https://wiki.alliedmods.net/AMX_Mod_X "AMX Mod X"). 
# Usage Questions
...
A: AMX Mod X is being rewritten from the ground up as SourceMod. You can check it out here: www.sourcemod.net
...
A: You can post in the forums about it or write a notice on the SF project page (<http://www.sf.net/projects/amxmodx>). 
...
A: We sure do! Go to<http://www.amxmodx.org/> and click on "Compiler". 
...
A: MetamodX was a set of patches to Metamod after the project seemed to be dead. The set of patches were trivial and written by[BAILOPAN](https://wiki.alliedmods.net/index.php?title=BAILOPAN&action=edit&redlink=1 "BAILOPAN \(page does not exist\)"), mainly as an effort to showing that if something was not done, Metamod would continue to be forked. Eventually [Will Day](https://wiki.alliedmods.net/index.php?title=Will_Day&action=edit&redlink=1 "Will Day \(page does not exist\)") named [Florian Zschocke](https://wiki.alliedmods.net/index.php?title=Florian_Zschocke&action=edit&redlink=1 "Florian Zschocke \(page does not exist\)"), the Admin-Mod maintainer, the new project maintainer for Metamod. Although Florian now maintains Metamod, Will Day is on the project as the wisened sage ;] 
...
`**Q:** Is OLO[](https://wiki.alliedmods.net/OLO "OLO") or dJeyL[](https://wiki.alliedmods.net/DJeyL "DJeyL") affiliated with AMX Mod X?`  
A: Dear me, I should hope not!
  
`**Q:** Does OLO[](https://wiki.alliedmods.net/OLO "OLO") approve of AMX Mod X?`  
A: Who cares?
