# Functions in zp50_ammopacks.inc
Function | Description  
---|---  
[zp_ammopacks_get](https://amxx-bg.info/api/zp50_ammopacks/zp_ammopacks_get) | ```
Returns a player's ammo pack count.
```
  
[zp_ammopacks_set](https://amxx-bg.info/api/zp50_ammopacks/zp_ammopacks_set) | ```
Sets a player's ammo pack count.
```
  

This code is a part of zp50_ammopacks.inc. To use this code you should include zp50_ammopacks.inc as ```#include <zp50_ammopacks>```
