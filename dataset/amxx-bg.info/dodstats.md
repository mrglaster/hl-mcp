# Functions in dodstats.inc
Function | Description  
---|---  
[get_user_wstats](https://amxx-bg.info/api/dodstats/get_user_wstats) | ```
...
[get_user_wrstats](https://amxx-bg.info/api/dodstats/get_user_wrstats) | ```
Gets round stats from given weapon index.
```
  
[get_user_wlstats](https://amxx-bg.info/api/dodstats/get_user_wlstats) | ```
Gets life (from spawn to spawn) stats from given weapon index.
```
  
[get_user_stats](https://amxx-bg.info/api/dodstats/get_user_stats) | ```
Gets overall stats which are stored in file on server
and updated on every respawn or user disconnect.
Function returns the position in stats by diff. kills to deaths.
```
  
[get_user_rstats](https://amxx-bg.info/api/dodstats/get_user_rstats) | ```
Gets round stats of player.
```
  
[get_user_lstats](https://amxx-bg.info/api/dodstats/get_user_lstats) | ```
Gets life (from spawn to spawn) stats of player.
```
  
[get_user_vstats](https://amxx-bg.info/api/dodstats/get_user_vstats) | ```
...
[get_user_astats](https://amxx-bg.info/api/dodstats/get_user_astats) | ```
Gets stats with which user have been killed/hurt. If killer is 0
then stats are from all attacks. If killer has not hurt user, function
returns 0 in other case 1. User stats are reset on his respawn.
```
  
[reset_user_wstats](https://amxx-bg.info/api/dodstats/reset_user_wstats) | ```
Resets life, weapon, victims and attackers user stats.
```
  
[get_stats](https://amxx-bg.info/api/dodstats/get_stats) | ```
...
[get_statsnum](https://amxx-bg.info/api/dodstats/get_statsnum) | ```
Returns number of all entries in stats.
```
  

This code is a part of dodstats.inc. To use this code you should include dodstats.inc as ```#include <dodstats>```
